...
// src/cli.ts
var cli = cac("gress-dev");
cli.command("[root]", "Start dev server").option("-c, --config <file>", "Use specified config file").option("-p, --port <port>", "Port to use").option("--open", "Open browser on startup").action(async (root = ".", options) => {
  const cwd = root;
  try {
