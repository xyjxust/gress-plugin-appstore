...
var LoadStrategy = /* @__PURE__ */ ((LoadStrategy2) => {
...
var PluginLifecycleEvent = /* @__PURE__ */ ((PluginLifecycleEvent2) => {
...
var ExtensionEvent = /* @__PURE__ */ ((ExtensionEvent2) => {
...
const useRouter = () => useHostBridge().router;
const useRoute = () => useHostBridge().route;
const useMessage = () => useHostBridge().message;
const useDialog = () => useHostBridge().dialog;
const useNotification = () => useHostBridge().notification;
const useLoadingBar = () => useHostBridge().loadingBar;
const useHttp = () => useHostBridge().http;
const useEvents = () => useHostBridge().events;
const useUtils = () => useHostBridge().utils;
exports.ExtensionEvent = ExtensionEvent;
exports.Icons = Icons;
exports.LoadStrategy = LoadStrategy;
exports.LogLevel = LogLevel;
exports.PluginError = PluginError;
exports.PluginErrorType = PluginErrorType;
exports.PluginLifecycleEvent = PluginLifecycleEvent;
exports.PluginPermission = PluginPermission;
exports.PluginStatus = PluginStatus;
exports.createEventEmitter = createEventEmitter;
exports.createPluginBridge = createPluginBridge;
exports.createPluginContext = createPluginContext;
exports.exposePluginBridge = exposePluginBridge;
...
exports.useIconComputed = useIconComputed;
