...
// node_modules/@keqi.gress/shared-utils/dist/index.js
var defaultHeaderConfig = (_config) => {
  const headers = {};
...
function set(obj, path, value) {
  ...
  let current = obj;
  for (const key of keys) {
    if (!(key in current) || !isObject2(current[key])) {
      current[key] = {};
    }
    current = current[key];
  }
...
//# sourceMappingURL=@keqi__gress_shared-utils.js.map
